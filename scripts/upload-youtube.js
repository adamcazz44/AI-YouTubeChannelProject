...
const CHANNEL = "Digital Grind";
const TITLE_MAX = 100;
const CATEGORY_ID = "26"; // Howto & Style — confirmed for motivation CPM (NOT 22)

const DESCRIPTION = `You're building something. Alone. Without a roadmap.

Digital Grind is fuel for the self-taught entrepreneur grinding to build real wealth through the internet — on your own terms.
...
const TAGS = [
  ...
  "digital grind", "side hustle", "internet business", "build wealth online",
  "self made", "passive income", "work from home", "make money online",
  "mindset", "success", "grind",
];
