...
// claude-sonnet-4-5 (per spec) is still valid but older; claude-sonnet-4-6 is the current
// latest Sonnet. Overridable via env. The spec's claude-3-5-sonnet fallback is RETIRED.
const MODEL = process.env.OMYT_QUOTES_MODEL || "claude-sonnet-4-6";
const MAX_TOKENS = 2048;
const TEMPERATURE = 1.0; // creative variety; supported on Sonnet 4.6

const ALLOWED_EMOTIONS = ["defiant", "determined", "urgent", "hopeful", "raw", "cinematic"];
const FORBIDDEN = [
  "hustle", "grind harder", "believe in yourself", "dream big",
  "never give up", "you got this", "crush it", "mindset",
];
