 ...
 *
 * Consumes a quotes JSON file (Spec 3) + footage clips (Spec 2) and renders the
 * Remotion `MotivationVideo` composition to output/<sanitized_theme>_<ts>.mp4, then
 * upserts output/manifest.json. Reads only — never modifies the footage/quotes manifests.
 *
 * Usage:
 *   node scripts/render-video.js "grinding in obscurity"
 *   npm run render:video -- "grinding in obscurity"
 */
"use strict";
...
const REMOTION_DIR = path.join(ROOT, "remotion", "motivation-renderer");
